...
class TimeTracker:
    ...
    def PrintTimeDetails(self):
        ...
        print()
        print("max Time taken for Task :" + str(self.maxTimetakenbyTask ))
        print("min Time taken for Task :" + str(self.minTimetakenbyTask ))
        print("avg Time Taken byTasks:" + str(avgTimetakenbyTask ))
    ...
    def PrintResult(self,  slot):
        if self.total_time > 0:
            ...
            print("      Throughput:" + str(TH ))
             ...
             print("Device:"+ self.name + "Not Used" )
